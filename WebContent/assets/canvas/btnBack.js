 ...
 */
function btnBack(aGame, aX, aY, aKey, aCallback, aCallbackContext, aOverFrame, aOutFrame, aDownFrame, aUpFrame) {
	Phaser.Button.call(
		this, aGame, aX, aY,
		aKey || 'btnBack',
		aCallback || this.goToMenu,
...
/** @type Phaser.Button */
var btnBack_proto = Object.create(Phaser.Button.prototype);
btnBack.prototype = btnBack_proto;
btnBack.prototype.constructor = btnBack;

/* --- end generated code --- */
// -- user code here --
btnBack.prototype.goToMenu = function() {
