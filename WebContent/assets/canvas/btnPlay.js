 ...
 */
function btnPlay(aGame, aX, aY, aKey, aCallback, aCallbackContext, aOverFrame, aOutFrame, aDownFrame, aUpFrame) {
	Phaser.Button.call(
		this, aGame, aX, aY,
		aKey || 'btnPlay',
		aCallback || this.goToLevel,
...
/** @type Phaser.Button */
var btnPlay_proto = Object.create(Phaser.Button.prototype);
btnPlay.prototype = btnPlay_proto;
btnPlay.prototype.constructor = btnPlay;

/* --- end generated code --- */
// -- user code here --
btnPlay.prototype.goToLevel = function() {
